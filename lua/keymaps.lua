...
local function merge_tables(options, description)
...
-- Window Movement
vim.keymap.set("n", "<C-h>", "<C-w><C-h>", merge_tables(opts, { desc = "Move focus to the left window" }))
vim.keymap.set("n", "<C-l>", "<C-w><C-l>", merge_tables(opts, { desc = "Move focus to the right window" }))
vim.keymap.set("n", "<C-j>", "<C-w><C-j>", merge_tables(opts, { desc = "Move focus to the lower window" }))
vim.keymap.set("n", "<C-k>", "<C-w><C-k>", merge_tables(opts, { desc = "Move focus to the upper window" }))
vim.keymap.set("n", "<C-Left>", "<C-w><C-h>", merge_tables(opts, { desc = "Move focus to the left window" }))
vim.keymap.set("n", "<C-Right>", "<C-w><C-l>", merge_tables(opts, { desc = "Move focus to the right window" }))
vim.keymap.set("n", "<C-Down>", "<C-w><C-j>", merge_tables(opts, { desc = "Move focus to the lower window" }))
vim.keymap.set("n", "<C-Up>", "<C-w><C-k>", merge_tables(opts, { desc = "Move focus to the upper window" }))
